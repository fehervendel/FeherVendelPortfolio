...
export default function Footer() {
    ...
    return (
        <>
            <AnimationWrapper delay="0.2s"><div id="footer" className="border-t border-b border-stone-50 w-full md:flex py-8 justify-between border-b-amber-50/30">
                ...
                <p className="!text-xl !text-stone-50 md:px-16 text-center flex items-center py-8 md:py-0"><AnimationWrapper delay="0.2s">{footerContent[0].textContent}</AnimationWrapper></p>
